    ...
    public void RunInstallersFromReferencedAssemblies_discovers_modules_from_the_anchor_dependency_context()
    {
        ...
        Assert.Contains(
            ...
            descriptor => descriptor.ServiceType.FullName ==
                          "CodexGateway.Api.OpenAI.OpenAiChatCompletionMapper");
        Assert.Contains(
            services,
            descriptor => descriptor.ServiceType.FullName ==
        ...
        Assert.Contains(
            services,
            descriptor => descriptor.ServiceType.FullName ==
                          "CodexGateway.Infrastructure.Codex.ContainerCodexRunner");
        ...
        var preflightIndex = Array.IndexOf(
            hostedServiceTypes,
            typeof(CodexGateway.Infrastructure.Codex.ContainerRuntimePreflightService));
        var temporaryCleanupIndex = Array.IndexOf(
            hostedServiceTypes,
            typeof(CodexGateway.Infrastructure.Storage.TemporaryFileCleanupService));
