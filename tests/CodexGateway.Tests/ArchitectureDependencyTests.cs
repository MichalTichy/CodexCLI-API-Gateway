...
public sealed class ArchitectureDependencyTests
{
    ...
    [Theory]
    [InlineData(typeof(CodexGateway.App.AppInstaller))]
    [InlineData(typeof(CodexGateway.Api.GatewayApiInstaller))]
    [InlineData(typeof(CodexGateway.Logic.LogicInstaller))]
    [InlineData(typeof(CodexGateway.Infrastructure.Codex.CodexInfrastructureInstaller))]
    [InlineData(typeof(CodexGateway.Infrastructure.Storage.StorageInfrastructureInstaller))]
    ...
    public void Management_actions_are_named_logic_requests_with_handlers()
    {
        ...
        var logicTypes = typeof(CodexGateway.Logic.LogicInstaller).Assembly.GetTypes();
