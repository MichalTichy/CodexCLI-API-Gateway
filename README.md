...
| `McpGateway:MaxMaterializedFiles` | `10` | Maximum number of `artifact://` binary resources that MCP tools may materialize in one run |
| `McpGateway:MaxMaterializedFileMegabytes` | `25` | Maximum decoded size of one materialized MCP resource |
| `McpGateway:MaxMaterializedTotalMegabytes` | `50` | Maximum combined decoded size of all materialized MCP resources in one run |
